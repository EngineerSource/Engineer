...
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './File_Bot/games.lua', '✯︙ملف الالعاب الخاص بسورس المهندس')
end 
end
...
if text == 'تفعيل all' and CoSu(msg) or text == 'تفعيل @all' and CoSu(msg) then
...
if text == 'تعطيل all' and CoSu(msg) or text == 'تعطيل @all' and CoSu(msg) then  
if not database:get(bot_id..'Cick:all'..msg.chat_id_) then
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/AudiosWaTaN/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_, t..'ٴ≪━━━━ المهندس ━━━━≫ٴٴ\n✯︙➫ .[🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 ����𝙽𝙴𝙴𝚁. ](t.me/ba8lawa)➤ ')
end
