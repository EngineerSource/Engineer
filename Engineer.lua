...
local Status = DevAbs:sismember(Engineer..'Abs:ManagerAll:',msg.sender_user_id_) 
...
local Status = DevAbs:sismember(Engineer..'Abs:AdminAll:',msg.sender_user_id_) 
...
------ Vip Member All ------
function VipAll(msg) 
local Status = DevAbs:sismember(Engineer..'Abs:VipAll:',msg.sender_user_id_) 
...
var = true  
elseif DevAbs:sismember(Engineer..'Abs:ManagerAll:', user_id) then
var = true  
elseif DevAbs:sismember(Engineer..'Abs:AdminAll:', user_id) then
var = true  
elseif DevAbs:sismember(Engineer..'Abs:VipAll:', user_id) then
var = true  
...
elseif tonumber(msgs) < 10000 then 
MsgText = 'لازم نزوجك صاكه' 
...
DevAbs:del(Engineer..'Abs:Text:GpTexts'..Abbs..data.chat_id_)
DevAbs:srem(Engineer..'Abs:Manager:GpRedod'..data.chat_id_,Abbs)
end
if DataText and DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)') then
local Abbs = DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)')
local List = DevAbs:smembers(Engineer..'Abs:Text:GpTexts'..Abbs..data.chat_id_)
...
if DevAbs:sismember(Engineer.."Coomds"..msg.chat_id_,DEV_ABBAS) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local mrabs = DevAbs:get(Engineer.."Comd:New:rt:Abs:"..DEV_ABBAS..msg.chat_id_)
if mrabs == "مميز" and VipMem(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'Engineer')..')'..' ❩\n⌁︙تم رفعه ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
DevAbs:set(Engineer.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_ABBAS) 
...
if mrabs == "مميز" and VipMem(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'Engineer')..')'..' ❩\n⌁︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
local inline = {{{text="⌁ المطور .",url="t.me/"..(dp.username_ or "ba8lawa")}}}
...
if DevAbs:get(Engineer..'Abs:Lock:NightClub'..msg.chat_id_) and msg.reply_to_message_id_ == 0 then
...
HttpsMsg = https.request('https://apiabs.ml/nightclub.php?Get=Engineer&TokenBot='..TokenBot..'&Url='..UrlId)
...
tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = Engineer,offset_ = 0,limit_ = 1},function(extra,abbas,success) 
...
if DevAbs:get(Engineer.."Abs:Photo:BotWelcome") then AbsPhoto = DevAbs:get(Engineer.."Abs:Photo:BotWelcome") elseif abbas.photos_[0] then AbsPhoto = abbas.photos_[0].sizes_[1].photo_.persistent_id_ else AbsPhoto = nil end 
...
--     Source Engineer     --
if text == 'كت' or text == 'كت تويت' and ChCheck(msg) then
if not DevAbs:get(Engineer..'Abs:Lock:Games'..msg.chat_id_) then
...
{{text = '᥀ Engineer Team .', url="t.me/RR17D"}},
...
if DevAbs:get(Engineer.."Abs:Left:Bot"..Engineer) and not SecondSudo(msg) then
...
local text =  [[
مـرحـبا بـكـم فـي سـورس
الـمـهـنـدس حـسـن الـبـصـراوي

        [قناة الہسہورسہ](https://t.me/ba8lawa)

        [الہمطہور](https://t.me/BlackBirdd)

    [بہوتہ ألتہوأصہل](t.me/Eng900Bot)
]]
...
local text =  [[
                ...
                [@blackbirdd](https://t.me/BlackBirdd)
...
if DevAbs:sismember(Engineer..'Abs:ManagerAll:',result.sender_user_id_) then
managerall = 'المدراء العامين • ' else managerall = '' end
if DevAbs:sismember(Engineer..'Abs:AdminAll:',result.sender_user_id_) then
adminall = 'الادمنيه العامين • ' else adminall = '' end
if DevAbs:sismember(Engineer..'Abs:VipAll:',result.sender_user_id_) then
...
DevAbs:srem(Engineer..'Abs:ManagerAll:', result.sender_user_id_)
DevAbs:srem(Engineer..'Abs:AdminAll:', result.sender_user_id_)
DevAbs:srem(Engineer..'Abs:VipAll:', result.sender_user_id_)
...
sudobot = 'المطورين • ' else sudobot = '' end
if DevAbs:sismember(Engineer..'Abs:ManagerAll:',result.id_) then
managerall = 'المدراء العامين • ' else managerall = '' end
if DevAbs:sismember(Engineer..'Abs:AdminAll:',result.id_) then
adminall = 'الادمنيه العامين • ' else adminall = '' end
if DevAbs:sismember(Engineer..'Abs:VipAll:',result.id_) then
vpall = 'المميزين العامين • ' else vpall = '' end
...
DevAbs:srem(Engineer..'Abs:ManagerAll:', result.id_)
DevAbs:srem(Engineer..'Abs:AdminAll:', result.id_)
DevAbs:srem(Engineer..'Abs:VipAll:', result.id_)
...
DevAbs:sadd(Engineer..'Abs:ManagerAll:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevAbs:sadd(Engineer..'Abs:ManagerAll:',result.id_)
...
DevAbs:sadd(Engineer..'Abs:ManagerAll:',user)
...
DevAbs:srem(Engineer..'Abs:ManagerAll:',user)
...
function raf_reply(extra, result, success)
DevAbs:sadd(Engineer..'Abs:AdminAll:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevAbs:sadd(Engineer..'Abs:AdminAll:',result.id_)
...
DevAbs:sadd(Engineer..'Abs:AdminAll:',user)
...
DevAbs:srem(Engineer..'Abs:AdminAll:',user)
...
function raf_reply(extra, result, success)
DevAbs:sadd(Engineer..'Abs:VipAll:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevAbs:sadd(Engineer..'Abs:VipAll:',result.id_)
...
DevAbs:sadd(Engineer..'Abs:VipAll:',user)
...
DevAbs:srem(Engineer..'Abs:VipAll:',user)
...
function prom_reply(extra, result, success)
if not BasicConstructor(msg) and DevAbs:get(Engineer.."Abs:Lock:ProSet"..msg.chat_id_) then 
...
if DevAbs:sismember(Engineer..'Abs:SecondSudo:',result.sender_user_id_) and not Sudo(msg) then
...
if DevAbs:sismember(Engineer..'Abs:SecondSudo:',result.id_) and not Sudo(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌁︙*لاتستطيع حظر المطور الثانوي*", 1, 'md')
return false 
end
if result.id_ then
...
if DevAbs:sismember(Engineer..'Abs:SecondSudo:',user) and not Sudo(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌁︙*لاتستطيع حظر المطور الثانوي*", 1, 'md')
return false 
end
ChatKick(msg.chat_id_, user)
...
if DevAbs:get(Engineer..'Abs:Lock:Clean'..msg.chat_id_) then if msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.photo_ or msg.content_.animation_ then if msg.reply_to_message_id_ ~= 0 then DevAbs:sadd(Engineer.."Abs:cleaner"..msg.chat_id_, msg.id_) else DevAbs:sadd(Engineer.."Abs:cleaner"..msg.chat_id_, msg.id_) end end end
...
local List = DevAbs:smembers(Engineer..'Abs:ManagerAll:')
...
local List = DevAbs:smembers(Engineer..'Abs:VipAll:')
...
if not DevAbs:get(Engineer..'Abs:Lock:NightClub'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌁︙تم قفل الاباحي")  
DevAbs:set(Engineer..'Abs:Lock:NightClub'..msg.chat_id_,true)
else
...
changeChatMemberStatus(group[i], Engineer, "Left")
w = w + 1
end
...
if msg and DevAbs:get(Engineer..'Abs:Lock:Clean'..msg.chat_id_) then
...
if DevAbs:scard(Engineer.."Abs:cleaner"..msg.chat_id_) >= tonumber(CleanNum) then 
local List = DevAbs:smembers(Engineer.."Abs:cleaner"..msg.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
...
if DevAbs:get(Engineer..'Abs:Lock:NightClub'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌁︙تم فتح الاباحي")  
DevAbs:del(Engineer..'Abs:Lock:NightClub'..msg.chat_id_)
else
...
DevAbs:del(Engineer..'Abs:AdminAll:')
end
...
DevAbs:del(Engineer..'Abs:VipAll:')
end
...
DevAbs:del(Engineer..'Abs:ManagerAll:')
end
...
if DevAbs:get(Engineer..'Abs:Lock:NightClub'..msg.chat_id_) then mute_nightclub = 'مقفل' else mute_nightclub = 'مفتوح' end
...
if text and text:match("^انطق (.*)$") and not DevAbs:get(Engineer..'Abs:Antk:Abs'..msg.chat_id_) then
...
if text and text ~= "نسبه الكره" and text ~= "نسبة الكره" and DevAbs:get(Engineer..'HataNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
if text and text ~= "نسبه الرجوله" and text ~= "نسبة الرجوله" and text ~= "نسبه رجوله" and text ~= "نسبة رجوله" and DevAbs:get(Engineer..'RjolaNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
if text and text ~= "نسبه الانوثه" and text ~= "نسبة الانوثه" and text ~= "نسبه انوثه" and text ~= "نسبة انوثه" and DevAbs:get(Engineer..'AnothaNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
if text and text ~= "نسبه الغباء" and text ~= "نسبة الغباء" and DevAbs:get(Engineer..'StupidNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
--     Source Engineer     --
if text == "غنيلي" or text == "غني" and ChCheck(msg) then
...
if LinkGp.ok == true then LinkGroup = LinkGp.result else LinkGroup = 't.me/Engineer' end
...
--     Source Engineer     --
if text == 'حذف رد' and Admin(msg) and ChCheck(msg) or text == 'مسح رد' and  Admin(msg) and ChCheck(msg) then
...
if text == 'اضف رد' and Admin(msg) and ChCheck(msg) then
...
if text == 'حذف الردود المتعدده' and AbsConstructor(msg) and ChCheck(msg) or text == 'مسح الردود المتعدده' and AbsConstructor(msg) and ChCheck(msg) then
local redod = DevAbs:smembers(Engineer..'Abs:Manager:GpRedod'..msg.chat_id_)
if #redod == 0 then
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌁︙لا توجد ردود متعدده مضافه" ,  1, "md")
else
...
--     Source Engineer     --
if text == 'الردود' and Admin(msg) and ChCheck(msg) or text == 'ردود المدير' and Admin(msg) and ChCheck(msg) then
...
if text == 'حذف الردود' and Admin(msg) and ChCheck(msg) or text == 'مسح الردود' and Admin(msg) and ChCheck(msg) or text == 'حذف ردود المدير' and Admin(msg) and ChCheck(msg) or text == 'مسح ردود المدير' and Admins(msg) and ChCheck(msg) then
local redod = DevAbs:smembers(Engineer..'Abs:Manager:GpRed'..msg.chat_id_)
if #redod == 0 then
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌁︙لا توجد ردود مضافه" ,  1, "md")
else
...
if DevAbs:get(Engineer.."DevAbs2") then
DevAbs:set(Engineer.."Abs:ChId",DevAbs:get(Engineer.."DevAbs2"))
DevAbs:del(Engineer.."DevAbs2")
end
if DevAbs:get(Engineer.."Abs:textch:user") then
DevAbs:set(Engineer.."Abs:ChText",DevAbs:get(Engineer.."Abs:textch:user"))
DevAbs:del(Engineer.."Abs:textch:user")
end
--     Source Engineer     --
...
if DevAbs:get(Engineer..'Abs:Lock:EditMsgs'..msg.chat_id_) and not Text and not BasicConstructor(result) then
